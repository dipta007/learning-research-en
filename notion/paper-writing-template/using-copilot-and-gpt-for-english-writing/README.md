...
1. List the basic outline of the whole Introduction
   ...
   ![image.png](./assets/1143fe292ff1805d812ddb353a50b716-image.png)
...
3. Make an initial list of the outline of every sentence in the paragraph
   ...
   ![image.png](./assets/1143fe292ff18008940ed875071cc72c-image.png)
...
4. Based on each sentence's outline, write with Copilot's help
   ...
   ![image.png](./assets/1143fe292ff1806888a6d2091acf544c-image.png)
...
5. While writing sentence by sentence, refine the paragraph's outline (the key to a clear paragraph outline)
   ...
   ![image.png](./assets/1143fe292ff1804abd46c9c31a866635-image.png)

   Version 2:

   ![image.png](./assets/1143fe292ff180d6a08dd3d8817faeaa-image.png)

   Version 3:

   ![image.png](./assets/1143fe292ff180beab9fc6908961bff4-image.png)

   Version 4:

   ![image.png](./assets/1143fe292ff180d2af74d289cc49f51a-image.png)

   Version 5:

   ![image.png](./assets/1143fe292ff1805c802ac40bb281b04b-image.png)
...
1. Make an initial list of the outline of one sentence
   ...
   ![image.png](./assets/1143fe292ff180338bcdf541db66f285-image.png)
...
2. Based on that sentence's outline, write with Copilot's help
   ...
   ![image.png](./assets/1143fe292ff18083b22dd170eec997d8-image.png)
...
3. The vocabulary Copilot gives is not necessarily accurate, so polish it with GPT's help
   ...
   1. Approach 1: mixing Chinese and English, ask it directly to improve the English sentence (useful)
      ...
      ![image.png](./assets/1143fe292ff180a484b0d4fd34d4dd95-image.png)
      ![image.png](./assets/1143fe292ff180a79913f6406dac852e-image.png)
   ...
   2. Approach 2: ask about individual words
      ...
      ![image.png](./assets/1143fe292ff180968881d6c7e05d0c1b-image.png)
      ![image.png](./assets/1143fe292ff18043bbb2e195a5c93cfd-image.png)
      ![image.png](./assets/1143fe292ff180afaa85eaa1d7f160d1-image.png)
...
5. While writing the sentence, refine the sentence's outline
   ...
   ![image.png](./assets/1143fe292ff180829e48fbdac98ffc72-image.png)

   Version 2:

   ![image.png](./assets/1143fe292ff180c6b919f94af323130f-image.png)
