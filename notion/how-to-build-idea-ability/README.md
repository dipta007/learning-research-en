...
> **note** In fact an advisor can hardly find time to design a project's technical details, and the student needs to realize that the only way out is to think of the solution themselves.
